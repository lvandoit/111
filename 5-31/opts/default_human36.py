...
opt.data_dir   = '/home/hxs/output/2rel_3d_pose/opts/human3.6'

# save path for experiments and experiment name
opt.ckpt = 'checkpoint/'
opt.exp  = 'default_human'
...
#opt.train_noise_type_2d   = 'detections'
opt.train_noise_amount_2d = 0
opt.test_noise_type_2d    = 'none'
...
opt.loss_weights['subj']     = 0.0
opt.loss_weights['len']      = 0.0
